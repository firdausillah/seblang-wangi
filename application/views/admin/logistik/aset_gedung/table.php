<div class="card p-3">
    <div class="d-flex justify-content-between">
        ...
        <span>
            <a href="#" onclick="exportExcel('<?= base_url('admin/logistik/aset_gedung/') ?>')" class="btn btn-sm btn-info my-auto">Export Excel</a>
            ...
            <tbody class="table-border-bottom-0">
                <?php foreach ($aset_gedung as $index => $item) : ?>
                    <tr>
                        ...
                        <td>
                            <a class="text-info" href="<?= base_url('admin/logistik/aset_gedung?page=edit&id=' . $item->id) ?>"><i class="bx bx-edit-alt me-1"></i></a>
                            <a class="text-danger" href="#" onclick="confirmDelete('<?= base_url('admin/logistik/aset_gedung/nonaktif/' . $item->id) ?>')"><i class="bx bx-trash me-1"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
