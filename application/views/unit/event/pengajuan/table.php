<div class="card p-3">
    <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url('unit/event/event?page=add') ?>" class="btn btn-sm btn-success my-auto">Tambah data</a>
        ...
        <table id="datatables_table" class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                <?php foreach ($event_unit as $index => $item) : ?>
                    <tr>
                        <td><?= $index + 1 ?></td>
                        <td><a href="<?= base_url('unit/event/event?page=detail&id=' . $item->id) ?>" class="text-black"><?= $item->nama ?></a></td>
                        <td>
