...
class Unit_kordinator extends CI_Controller
{
    public $defaultVariable = 'unit_kordinator';
    public $url_index = 'admin/relawan/unit_kordinator';
    
    function __construct()
    {
        parent::__construct();
        $this->load->model('Unit_kordinatorModel', 'defaultModel');
