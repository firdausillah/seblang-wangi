...
class Kesehatan extends CI_Controller
{
    ...
    public $url_index = 'admin/yankes/kesehatan';
    ...
    public function index()
    {
        ...
        $kategori_pelayanan = ['Operasi Katarak, Pemeriksaan Mata dan Pemasangan Bola Mata Palsu', 'Pelayanan PP Ambulance', 'Foging', 'HIV/AIDS', 'Stunting', 'TB Paru'];

        if ($page == 'index') {
            $data = [
                'title' => 'Pelayanan Kesehatan',
                $this->defaultVariable => $this->defaultModel->findBy(['jenis_pelayanan' =>'Kesehatan', 'is_active' => 1])->result(),
                'content' => 'admin/yankes/table',
                'jenis_pelayanan' => 'kesehatan'
            ];
    ...
    public function save()
    {
        ...
        $folderPath = './uploads/img/yankes/kesehatan/';
    ...
    public function exportExcel()
    {
        ...
        $pelaporan = $this->defaultModel->findBy(['is_active' => 1, 'jenis_pelayanan' => 'Kesehatan'])->result_array();
        $x = 2;
        ...
        $fileName = 'pelayanan-kesehatan-seblang-wangi-' . date('dmy') . '.xlsx';
